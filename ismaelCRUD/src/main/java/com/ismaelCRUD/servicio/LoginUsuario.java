...
public class LoginUsuario implements UserDetailsService{
	...
	public UserDetails loadUserByUsername(String nombreusuario) throws UsernameNotFoundException {
		...
		com.ismaelCRUD.modelo.Usuario cargarSesionUsuario = repositorioUsuario.findBynombreusuario(nombreusuario).orElseThrow(() -> new UsernameNotFoundException("El Login Del Usuario Es Invalido."));
		
		//mira maria esto lo tuve que hacer por  que despues de muchas horas me di cuenta de que spring security necesita para construir el usuario de mas abajo un rol
		//y como no tenia roles (por que si no tengo que generar una clase nueva y demas)demomento lo simulo y tira para delante en un futuro cuando acabe todo intentare poner roles
		...
		//aqui es donde me fallaba el login que me pedia que para generar el User (este user es de la clase userdetails no de la mia) me pedia un rol obligatoriamente
